document.addEventListener("DOMContentLoaded", () => {
  ...
  const configParam = urlParams.get('configuration');
  const typeParam = urlParams.get('propertyType');
  const toiletParam = urlParams.get('toilets');
  const balconyParam = urlParams.get('balcony');

  // Set filter values from URL parameters
  if (locationParam) document.getElementById('searchLocation').value = locationParam;
  if (configParam) document.getElementById('searchConfiguration').value = configParam;
  if (typeParam) document.getElementById('searchPropertyType').value = typeParam;
  if (toiletParam) document.getElementById('searchToilet').value = toiletParam;
  if (balconyParam) document.getElementById('searchBalcony').value = balconyParam;
